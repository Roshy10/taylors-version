const speak_now = [
    {
        // Mine
        "replacement": "spotify:track:7G0gBu6nLdhFDPRLc0HdDG",
        "originals": [
            // Original
    ...
    {
        // Sparks Fly
        "replacement": "spotify:track:3MytWN8L7shNYzGl4tAKRp",
        "originals": [
            // Original
    ...
    {
        // Back To December
        "replacement": "spotify:track:79uDOz0zuuWS7HWxzMmTa2",
        "originals": [
            // Original
    ...
    {
        // Speak Now
        "replacement": "spotify:track:5xXqyjLicvEpch72qEryFT",
        "originals": [
            // Original
    ...
    {
        // Dear John
        "replacement": "spotify:track:1zU8j1x3yi9xalMF96pzKp",
        "originals": [
            // Original
    ...
    {
        // Mean
        "replacement": "spotify:track:30Y4CV7A6YqtQtTTo7Ue4j",
        "originals": [
            // Original
    ...
    {
        // The Story Of Us
        "replacement": "spotify:track:6dTA6y0C2ReQklntzZl8l3",
        "originals": [
            // Original
    ...
    {
        // Never Grow Up
        "replacement": "spotify:track:2EFZ9emtKWEglWUQGEQ3P9",
        "originals": [
            // Original
            "spotify:track:1wJL1A0QUHJPf2cm7tsrdw",
            // Original Deluxe
            "spotify:track:74WBGgUnpKrJXt6TETfR6Z",
            // Repuation Stadium Tour Surprise Song
    ...
    {
        // Enchanted
        "replacement": "spotify:track:3sW3oSbzsfecv9XoUdGs7h",
        "originals": [
            // Original
    ...
    {
        // Better Than Revenge
        "replacement": "spotify:track:0NwGC0v03ysCYINtg6ns58",
        "originals": [
            // Original
    ...
    {
        // Innocent
        "replacement": "spotify:track:12nBPF4Rh4XLFJV0YLN7uj",
        "originals": [
            // Original
    ...
    {
        // Haunted
        "replacement": "spotify:track:4tMzIAFTFdqGBQLdfbPces",
        "originals": [
            // Original
    ...
    {
        // Last Kiss
        "replacement": "spotify:track:59KOoHFcw5XfICnO57holu",
        "originals": [
            // Original
    ...
    {
        // Long Live
        "replacement": "spotify:track:4hqJ4bSlYJOXb6Z4SRmzxs",
        "originals": [
            // Original
    ...
    {
        // Ours
        "replacement": "spotify:track:3yNJkriPzWjkkDAWHIAVUq",
        "originals": [
            // Original Deluxe
    ...
    {
        // Superman
        "replacement": "spotify:track:4evLyY5Ue1Wesc61t2KXAU",
        "originals": [
            // Original Deluxe
