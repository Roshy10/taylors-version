const spotify = [
    ...
    // Fearless
    {
        "replacement": "spotify:track:77sMIMlNaSURUAXq5coCxE",
        "originals": [
            // original
    ...
    // Fifteen
    {
        "replacement": "spotify:track:2nqio0SfWg6gh2eCtfuMa5",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:0H2UD0LfSCiRr59YMGlCuS",
        ],
    },

    // Love Story
    {
        "replacement": "spotify:track:3CeCwYWvdfXbZLXFhBrbnf",
        "originals": [
            // original
    ...
    // Hey Stephen
    {
        "replacement": "spotify:track:550erGcdD9n6PnwxrvYqZT",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:0TYJbIHBtmWy9ugtU9BcbE",
        ],
    },

    // White Horse
    {
        "replacement": "spotify:track:5YL553x8sHderRBDlm3NM3",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:4RMfSYDFkcz0bKoK8fHDgR",
        ],
    },

    // You Belong With Me
    {
        "replacement": "spotify:track:1qrpoAMXodY6895hGKoUpA",
        "originals": [
            // original
    ...
    // Breathe
    {
        "replacement": "spotify:track:7HC7R2D8WjXVcUHJyEGjRs",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:3oxgFdIlxFEDEJqn7k5TVN",
        ],
    },

    // Tell Me Why
    {
        "replacement": "spotify:track:0k0vFacOHNuArLWMiH60p7",
        "originals": [
            // original
    ...
    // You're Not Sorry
    {
        "replacement": "spotify:track:6iiAfo4wTA2CVC3Uwx9uh8",
        "originals": [
            // original
    ...
    // The Way I Loved You
    {
        "replacement": "spotify:track:22bPsP2jCgbLUvh82U0Z3M",
        "originals": [
            // original
    ...
    // Forever & Always
    {
        "replacement": "spotify:track:1msEuwSBneBKpVCZQcFTsU",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:0QCS4NpURHvWdF1icdkfBw",
        ],
    },

    // The Best Day
    {
        "replacement": "spotify:track:6ON9UuIq49xXY9GPmHIYRp",
        "originals": [
            // original
    ...
    // Change
    {
        "replacement": "spotify:track:3ExweHKZF9B752DPQByRVT",
        "originals": [
            // original
            ...
            // rep STSSP
            "spotify:track:5PSOWHll3h3Vy226xSJk0M",
        ],
    },
    ...
    {
        "replacement": "spotify:track:2JoJrsEV15OzbijS47lids",
        "originals": [
            // Single
